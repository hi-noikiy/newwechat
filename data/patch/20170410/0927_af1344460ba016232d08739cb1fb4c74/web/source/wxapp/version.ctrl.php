...
if ($do == 'edit') {
	...
	if ($operate == 'delete') {
		...
		message('删除成功', url('wxapp/version/edit', array('multiid' => $multiid, 'uniacid' => $_GPC['uniacid'], 'version_id' => $version_id, 'wxapp' => $type)), 'success');
	}
	if (checksubmit('submit')) {
		...
		if (!empty($slide)) {
			if (empty($id)) {
				...
				message('添加幻灯片成功', url('wxapp/version/edit', array('multiid' => $multiid, 'uniacid' => $_GPC['uniacid'], 'version_id' => $version_id, 'wxapp' => 'slide')), 'success');
			} else {
				$result = pdo_update('site_slide', $slide, array('uniacid' => $_GPC['uniacid'], 'multiid' => $multiid, 'id' => $id));
				message('更新幻灯片成功', url('wxapp/version/edit', array('multiid' => $multiid, 'uniacid' => $_GPC['uniacid'], 'version_id' => $version_id, 'wxapp' => 'slide')), 'success');
			}
		}
		if (!empty($nav)) {
			if (empty($id)) {
				...
				message('添加导航图标成功', url('wxapp/version/edit', array('wxapp' => 'nav', 'multiid' => $multiid, 'uniacid' => $_GPC['uniacid'], 'version_id' => $version_id, 'wxapp' => 'nav')), 'success');
			} else {
				pdo_update('site_nav', $nav, array('uniacid' => $_GPC['uniacid'], 'multiid' => $multiid, 'id' => $id));
				message('更新导航图标成功', url('wxapp/version/edit', array('wxapp' => 'nav', 'multiid' => $multiid, 'uniacid' => $_GPC['uniacid'], 'version_id' => $version_id, 'wxapp' => 'nav')), 'success');
			}
		}
		if (!empty($recommend)) {
			if (empty($id)) {
				...
				message('添加推荐图片成功', url('wxapp/version/edit', array('wxapp' => 'recommend', 'multiid' => $multiid, 'uniacid' => $_GPC['uniacid'], 'version_id' => $version_id, 'wxapp' => 'recommend')), 'success');
			} else {
				pdo_update('site_article', $recommend, array('uniacid' => $_GPC['uniacid'], 'id' => $id));
				message('更新推荐图片成功', url('wxapp/version/edit', array('wxapp' => 'recommend', 'multiid' => $multiid, 'uniacid' => $_GPC['uniacid'], 'version_id' => $version_id, 'wxapp' => 'recommend')), 'success');
			}
		}
	}
